 ...
 */
final class Version20210317084812 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE item ALTER count TYPE VARCHAR(255)');
        $this->addSql('ALTER TABLE item ALTER count DROP DEFAULT');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE "user" ALTER is_blocked SET DEFAULT \'false\'');
        $this->addSql('ALTER TABLE item ALTER count TYPE INT');
        $this->addSql('ALTER TABLE item ALTER count DROP DEFAULT');
